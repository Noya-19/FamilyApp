<template>
  <v-main class="chores">
    <v-container fluid class="chores__container">
      <v-col class="chores__daily-chores" cols="12">
        <v-row class="grey lighten-5" style="height: 300px;">
            ...
            <v-dialog v-model="dialog" persistent max-width="400px">
              ...
              <v-card>
                <v-card-text>
                  <v-container>
                    <v-row>
                      <v-col cols="12" max-width="300px" min-wdith="300px">
                        <v-text-field
                          label="Chore Name"
                          v-model="title"
          ...
          <v-container
            fluid
            class="chores__daily-chore-list d-flex flex-no-wrap justify-start align-stretch"
          >
      ...
      <v-col class="chores__todo" cols="12">
        <v-row class="grey lighten-5" style="height: 300px;">
          <v-toolbar color="indigo darken-4" dark>
          ...
          <v-container
            fluid
            class="chores__chore-list d-flex flex-no-wrap justify-start align-stretch"
          >
            <ChoreComponent
              v-for="chore of incompletedChores"
              :key="chore.id"
              :title="chore.title"
              :dueDate="chore.dueDate"
              :assignedTo="chore.assignedTo"
      ...
      <v-col class="chores__completed" cols="12">
        <v-row class="grey lighten-5" style="height: 300px;">
          <v-toolbar color="indigo darken-4" dark>
          ...
          <v-container
            fluid
            class="chores__completed-chore-list d-flex flex-no-wrap justify-start align-stretch"
          >
            <ChoreComponent
              v-for="chore of completedChores"
              :key="chore.id"
              :title="chore.title"
              :dueDate="chore.dueDate"
              :assignedTo="chore.assignedTo"
  ...
  methods: {
    async createChore () {
      ...
      this.$store.state.family.forEach(user => {
        if (
          user.firstname == this.assigned[0] &&
          user.lastname == this.assigned[1]
        ) { assignedTo = user.id }
      })
      try {
